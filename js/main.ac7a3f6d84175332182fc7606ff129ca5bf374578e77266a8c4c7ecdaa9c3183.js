...
function switchTab(tabGroup, tabId) {
  var allTabItems = document.querySelectorAll("[data-tab-group='" + tabGroup + "']");
  var targetTabItems = document.querySelectorAll("[data-tab-group='" + tabGroup + "'][data-tab-item='" + tabId + "']");

  for (let item of allTabItems) {
    item.classList.remove("active");
  }
  for (let item of targetTabItems) {
